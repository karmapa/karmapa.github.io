...
require.register("tibetansearch-main/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("tibetansearch-queryinfo/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var expandedToken=React.createClass({displayName: 'expandedToken',
  ...
  showtokenwithhits:function(tokenwithhits,variants) {
    if (tokenwithhits!=variants.length) {
      return React.DOM.span(null, React.DOM.span( {className:"label label-warning"}, tokenwithhits),"/",
      React.DOM.span( {className:"label label-info"}, this.props.token.variants.length))
    }else {
      return React.DOM.span( {className:"label label-info"}, this.props.token.variants.length)      
    }
  ...
  render:function() {
    ...
    return React.DOM.div( {className: " col-md-4"}, 
      React.DOM.span(null, this.props.token.raw),this.showtokenwithhits(tokenwithhits,this.props.token.variants),
       React.DOM.ul( {className:"expanded tokenlist list-group", style:{"height":"80%"}} , 
      token.variants.map(function(t,idx){
        if (t[1]==0) return ; // variants without hit
        var classes="list-group-item";
        if (idx==0) classes+=" active";
        return React.DOM.a( {href:"#",  'data-group':that.props.group, 
...
var queryinfo = React.createClass({displayName: 'queryinfo',
  ...
  help:function() {
    return React.DOM.span(null, React.DOM.strong(null, "Usage:"),
      React.DOM.br(null),"press enter for quick search.",
      React.DOM.br(null),"if the search phrase has only one wildcard syllable, hit [Filter] to eliminate impossible candidate.",
      React.DOM.br(null),"use space or shad to seperate multiple terms.",
      React.DOM.br(null),React.DOM.strong(null, "Wildcard Syllable:"),
      React.DOM.br(null),"x% :  match syllable starts with x",
      React.DOM.br(null),"%y :  match syllable ends with y",
      React.DOM.br(null),"%x% :  match syllable containing x",
      React.DOM.br(null),"x%y :  match syllable starts with x and ends with y",
      React.DOM.br(null),"maximum 3 syllables can have wildcard.",
      React.DOM.br(null),
      React.DOM.br(null),React.DOM.i(null, "Special thanks to Khenpo Karma Namgyal from leksheyling")
    )
  },
...
require.register("tibetansearch-resultlist/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var resultlist = React.createClass({displayName: 'resultlist',
  ...
  showLogo:function() {
    return (
    React.DOM.div( {className:"jumbotron span12 pagination-centered"}, 
     React.DOM.h1(null, "Tibetan Search Engine"),
        React.DOM.p(null, "version: 2014/7/10"),
        React.DOM.img( {align:"center", src:"treasure.png"})
    )
    );
  },
  showhit:function() {
  ...
  render: function() {
      if (this.props.Q) return React.DOM.div( {className:"resultlist"}, 
        "querystring:",React.DOM.span( {className:"query"}, this.props.Q.query),
          React.DOM.span( {className:"label label-info"}, this.showhit()),this.warning(),
        this.show()
      )
...
require.register("tibetansearch-pagetext/index.js", function(exports, require, module){
/** @jsx React.DOM */

//var othercomponent=Require("other"); 
var pagetext = React.createClass({displayName: 'pagetext',
  ...
  help:function() {
    return React.DOM.div(null, "help")
  },
  render: function() {
    if (!this.props.page) {
      return this.help();
    ...
    return (
      React.DOM.div( {className:"pagecontainter"}, 
        React.DOM.div( {className:"pagetext", dangerouslySetInnerHTML:{__html:this.props.page.text}}),        
      React.DOM.h5(null, React.DOM.span( {className:"label label-success"}, this.props.pagename))
      )
    );
  }
});
...
require.register("tibetansearch-searchbox/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var searchbox = React.createClass({displayName: 'searchbox',
  ...
  showfilter:function() {
    ...
    if (this.props.progress==1) {
      return React.DOM.button( {onClick:this.filter, className:"btn btn-warning"+disabled, type:"button"}, "Filter")  
    } else {
      return React.DOM.span(null, Math.floor(this.props.progress*100)+"%")
    }
  },
  render: function() {
    return (
      React.DOM.div( {className:"searchbox"}, 
         React.DOM.div( {className:"row"},  
              React.DOM.div( {className:"col-md-2"}, 
                React.DOM.button( {onClick:this.insertwildcard, className:"btn btn-default", type:"button"}, "%")
              ),
              React.DOM.div( {className:"col-md-8"}, 
                React.DOM.input( {defaultValue:"འ%ས་སོ", ref:"tofind", onChange:this.tofindchange, onKeyPress:this.keypress, type:"text", className:"form-control input-lg large-input"})
              ),
              React.DOM.div( {className:"col-md-2"}, 
                this.showfilter()
              )
...
require.register("tibetansearch/index.js", function(exports, require, module){
var boot=require("boot");
boot("tibetansearch","main","main");
});
...
require.alias("ksanaforge-boot/index.js", "tibetansearch/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "tibetansearch/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "boot/index.js");
require.alias("ksanaforge-boot/index.js", "ksanaforge-boot/index.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "tibetansearch/deps/bootstrap/dist/js/bootstrap.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "tibetansearch/deps/bootstrap/index.js");
...
require.alias("ksana-document/index.js", "tibetansearch/deps/ksana-document/index.js");
require.alias("ksana-document/document.js", "tibetansearch/deps/ksana-document/document.js");
require.alias("ksana-document/api.js", "tibetansearch/deps/ksana-document/api.js");
require.alias("ksana-document/xml.js", "tibetansearch/deps/ksana-document/xml.js");
require.alias("ksana-document/template_accelon.js", "tibetansearch/deps/ksana-document/template_accelon.js");
require.alias("ksana-document/persistent.js", "tibetansearch/deps/ksana-document/persistent.js");
require.alias("ksana-document/tokenizers.js", "tibetansearch/deps/ksana-document/tokenizers.js");
require.alias("ksana-document/markup.js", "tibetansearch/deps/ksana-document/markup.js");
require.alias("ksana-document/typeset.js", "tibetansearch/deps/ksana-document/typeset.js");
require.alias("ksana-document/sha1.js", "tibetansearch/deps/ksana-document/sha1.js");
require.alias("ksana-document/users.js", "tibetansearch/deps/ksana-document/users.js");
require.alias("ksana-document/customfunc.js", "tibetansearch/deps/ksana-document/customfunc.js");
require.alias("ksana-document/configs.js", "tibetansearch/deps/ksana-document/configs.js");
require.alias("ksana-document/projects.js", "tibetansearch/deps/ksana-document/projects.js");
require.alias("ksana-document/indexer.js", "tibetansearch/deps/ksana-document/indexer.js");
require.alias("ksana-document/indexer_kd.js", "tibetansearch/deps/ksana-document/indexer_kd.js");
require.alias("ksana-document/kdb.js", "tibetansearch/deps/ksana-document/kdb.js");
require.alias("ksana-document/kdbfs.js", "tibetansearch/deps/ksana-document/kdbfs.js");
require.alias("ksana-document/kdbw.js", "tibetansearch/deps/ksana-document/kdbw.js");
require.alias("ksana-document/kdb_sync.js", "tibetansearch/deps/ksana-document/kdb_sync.js");
require.alias("ksana-document/kdbfs_sync.js", "tibetansearch/deps/ksana-document/kdbfs_sync.js");
require.alias("ksana-document/html5fs.js", "tibetansearch/deps/ksana-document/html5fs.js");
require.alias("ksana-document/kse.js", "tibetansearch/deps/ksana-document/kse.js");
require.alias("ksana-document/kde.js", "tibetansearch/deps/ksana-document/kde.js");
require.alias("ksana-document/boolsearch.js", "tibetansearch/deps/ksana-document/boolsearch.js");
require.alias("ksana-document/search.js", "tibetansearch/deps/ksana-document/search.js");
require.alias("ksana-document/plist.js", "tibetansearch/deps/ksana-document/plist.js");
require.alias("ksana-document/excerpt.js", "tibetansearch/deps/ksana-document/excerpt.js");
require.alias("ksana-document/link.js", "tibetansearch/deps/ksana-document/link.js");
require.alias("ksana-document/tibetan/wylie.js", "tibetansearch/deps/ksana-document/tibetan/wylie.js");
require.alias("ksana-document/languages.js", "tibetansearch/deps/ksana-document/languages.js");
require.alias("ksana-document/diff.js", "tibetansearch/deps/ksana-document/diff.js");
require.alias("ksana-document/xml4kdb.js", "tibetansearch/deps/ksana-document/xml4kdb.js");
require.alias("ksana-document/buildfromxml.js", "tibetansearch/deps/ksana-document/buildfromxml.js");
require.alias("ksana-document/tei.js", "tibetansearch/deps/ksana-document/tei.js");
require.alias("ksana-document/concordance.js", "tibetansearch/deps/ksana-document/concordance.js");
require.alias("ksana-document/regex.js", "tibetansearch/deps/ksana-document/regex.js");
require.alias("ksana-document/index.js", "tibetansearch/deps/ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("tibetansearch-main/index.js", "tibetansearch/deps/main/index.js");
require.alias("tibetansearch-main/index.js", "tibetansearch/deps/main/index.js");
require.alias("tibetansearch-main/index.js", "main/index.js");
require.alias("tibetansearch-main/index.js", "tibetansearch-main/index.js");
require.alias("tibetansearch-queryinfo/index.js", "tibetansearch/deps/queryinfo/index.js");
require.alias("tibetansearch-queryinfo/index.js", "tibetansearch/deps/queryinfo/index.js");
require.alias("tibetansearch-queryinfo/index.js", "queryinfo/index.js");
require.alias("tibetansearch-queryinfo/index.js", "tibetansearch-queryinfo/index.js");
require.alias("tibetansearch-resultlist/index.js", "tibetansearch/deps/resultlist/index.js");
require.alias("tibetansearch-resultlist/index.js", "tibetansearch/deps/resultlist/index.js");
require.alias("tibetansearch-resultlist/index.js", "resultlist/index.js");
require.alias("tibetansearch-resultlist/index.js", "tibetansearch-resultlist/index.js");
require.alias("tibetansearch-pagetext/index.js", "tibetansearch/deps/pagetext/index.js");
require.alias("tibetansearch-pagetext/index.js", "tibetansearch/deps/pagetext/index.js");
require.alias("tibetansearch-pagetext/index.js", "pagetext/index.js");
require.alias("tibetansearch-pagetext/index.js", "tibetansearch-pagetext/index.js");
require.alias("tibetansearch-searchbox/index.js", "tibetansearch/deps/searchbox/index.js");
require.alias("tibetansearch-searchbox/index.js", "tibetansearch/deps/searchbox/index.js");
require.alias("tibetansearch-searchbox/index.js", "searchbox/index.js");
require.alias("tibetansearch-searchbox/index.js", "tibetansearch-searchbox/index.js");
require.alias("ksanaforge-fileinstaller/index.js", "tibetansearch/deps/fileinstaller/index.js");
require.alias("ksanaforge-fileinstaller/index.js", "tibetansearch/deps/fileinstaller/index.js");
...
require.alias("ksanaforge-htmlfs/index.js", "tibetansearch/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "tibetansearch/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "ksanaforge-htmlfs/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "tibetansearch/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "tibetansearch/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "ksanaforge-checkbrowser/index.js");
require.alias("tibetansearch/index.js", "tibetansearch/index.js");
if (typeof exports == 'object') {
  module.exports = require('tibetansearch');
} else if (typeof define == 'function' && define.amd) {
  define(function(){ return require('tibetansearch'); });
} else {
  window['tibetansearch'] = require('tibetansearch');
}})();