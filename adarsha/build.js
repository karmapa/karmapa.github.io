          ...
          React.createElement("div", {className: "borderright"}, 
            ...
            React.createElement("div", {className: "tab-content", ref: "tab-content"}, 
              React.createElement("div", {className: "tab-pane fade in active", id: "Catalog"}, 
                React.createElement(Stacktoc, {textConverter: this.textConverter, showText: this.showText, 
...
var renderDepth=function(depth,opts,nodetype) {
  ...
  if (opts.tocstyle=="vertical_line") {
    for (var i=0;i<depth;i++) {
      if (i==depth-1) {
        out.push(React.createElement("img", {src: opts.tocbar_start}));
      } else {
        out.push(React.createElement("img", {src: opts.tocbar}));  
      }
    }
    return out;    
  } else {
    if (depth) return React.createElement("span", null, depth, ".")
    else return null;
  }
  return null;
};
...
var Ancestors=React.createClass({displayName: 'Ancestors',
  ...
  renderAncestor:function(n,idx) {
    ...
    return React.createElement("div", {key: "a"+n, className: "node parent", 'data-n': n, onClick: this.goback}, renderDepth(idx,this.props.opts,"ancestor"), React.createElement("a", {className: "text", href: "#"}, text), this.showHit(hit))
  },
  render:function() {
...
var Children=React.createClass({displayName: 'Children',
  ...
  showHit:function(hit) {
    if (hit)  return React.createElement("a", {href: "#", onClick: this.showExcerpt, 
  ...
  renderChild:function(n) {
    ...
    text=trimText(text,this.props.opts)
    if (this.props.textConverter) text=this.props.textConverter(text);
    return React.createElement("div", {key: "child"+n, 'data-n': n}, renderDepth(depth,this.props.opts,"child"), React.createElement("a", {'data-n': n, className: classes +" tocitem text", onClick: this.nodeClicked}, text+" "), this.showHit(hit))
  },
  showText:function(e) { 
    var target=e.target;
    var n=e.target.dataset.n;
  ...
  render: function() {
    ...
    return ( 
      React.createElement("div", {className: "stacktoc"}, 
        React.createElement(Ancestors, {opts: opts, textConverter: this.props.textConverter, showExcerpt: this.hitClick, setCurrent: this.setCurrent, toc: this.props.data, data: ancestors}), 
        React.createElement("div", {className: "node current"}, renderDepth(depth-1,opts,"current"), React.createElement("a", {href: "#", onClick: this.showText, 'data-n': this.state.cur}, React.createElement("span", {className: "text"}, text)), this.showHit(current.hit)), 
        React.createElement(Children, {opts: opts, textConverter: this.props.textConverter, showTextOnLeafNodeOnly: this.props.showTextOnLeafNodeOnly, 
...
var searchbar = React.createClass({displayName: 'searchbar',
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("input", {className: "form-control", onInput: this.dosearch, ref: "tofind", defaultValue: "byang chub"}), 
